...
## 問題データベース
- **収録問題数**: 390問（中学受験対応完全版）
- **地理**: 52問（日本地理、世界地理、気候、産業、人口、時差計算等）
- **歴史**: 261問（古代から幕末、日本史・政治史・文化史網羅）
- **公民**: 77問（憲法、政府、国際関係、現代課題、経済・金融制度、環境問題等）
...
- 分野別統計機能
- 時間制限モード
- 地理問題の更なる充実（現在歴史261問に対し地理52問、公民77問に改善）
- 正誤問題形式の追加
- 画像・地図を使った問題
- 年表問題の可視化
- 解説の詳細化
