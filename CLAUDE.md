...
## 問題データベース
- **収録問題数**: 410問（中学受験対応完全版）
- **地理**: 58問（日本地理、世界地理、気候、産業、人口、時差計算、地図投影法等）
- **歴史**: 261問（古代から幕末、日本史・政治史・文化史網羅）
- **公民**: 91問（憲法、政府、国際関係、現代課題、経済・金融制度、環境問題、統計データ等）
...
- `~/docs/shakai-text/social_studies_test_14_basic.md`: 第14回BASIC問題（20問追加）
- `~/docs/shakai-text/social_studies_test_14_standard.md`: 第14回STANDARD問題（20問追加）
- `~/docs/shakai-text/social_studies_test_14_advanced.md`: 第14回ADVANCED問題（20問追加）
...
13. **現代総合基礎**: +20問（social_studies_test_14_basic.mdより）
14. **国際社会標準**: +20問（social_studies_test_14_standard.mdより）
15. **高度統合発展**: +20問（social_studies_test_14_advanced.mdより）
16. **現在**: 410問（地理58問、歴史261問、公民91問）
...
### 公民問題の詳細内訳（91問）
**憲法・政治制度（15問）:**
- 基本的人権、国会・内閣・裁判所、選挙制度、地方自治
- 議院内閣制、EU離脱（イギリス）等

**経済・金融（38問）:**
- GDP・GNP、日本銀行の機能、景気変動、貿易、経済史（世界恐慌、バブル経済等）
- TPP、現地生産、逆輸入、公共料金、社会保障関係費等
- 需要と供給の法則、価格変動、中央銀行制度等
- 農業・工業・エネルギーの統計データ、税制（消費税・軽減税率）

**国際関係・現代課題（38問）:**
- 国際機関（UNESCO、UNCTAD、国連等）、中東戦争、湾岸戦争
- 環境問題（カーボンニュートラル、地球サミット、パリ協定等）、南北問題・南南問題
- 非核三原則、核拡散防止条約、国際協力（ODA）等
- 世界地理（本初子午線、日付変更線、経度・緯度、地図投影法）、各国の特徴
- エネルギー問題（火力・太陽光・原子力発電）、宗教と地域紛争
- 冷戦史、国連システムの詳細、現代日本の経済指標
...
- 分野別統計機能
- 時間制限モード
- 地理問題の更なる充実（現在歴史261問に対し地理58問、公民91問に改善）
- 正誤問題形式の追加
- 画像・地図を使った問題
- 年表問題の可視化
- 解説の詳細化
